...
export default function FIFANewImport() {
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 14, color: '#64748B', margin: 0 }}>
              Upload and process new property data files
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 20 }}>
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., FIFA_2024_01_26"
                    style={{
                      width: '100%',
                      padding: '10px 12px',
                      borderRadius: 8,
            ...
            <div style={cardStyle}>
              ...
              <p style={{ fontSize: 13, color: '#64748B', margin: '0 0 10px 0' }}>
                Support for PDF (scanned documents) and Excel/CSV (data lists)
              </p>
              <div style={{ 
                ...
                <strong>Required Columns for Excel/CSV:</strong> parcel_id, address<br/>
                <strong>Optional:</strong> city, county, state, zip, purchase_price, current_value
              </div>
