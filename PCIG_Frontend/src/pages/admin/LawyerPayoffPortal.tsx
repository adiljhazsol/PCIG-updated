...
export default function LawyerPayoffPortal() {
  ...
  const data = portalData?.lawyerPayoffPortal || {};
  
  // Use raw objects for granular extraction
          ...
          <div>
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: `clamp(12px, 1.8vw, 14px)`, color: '#64748B', wordBreak: 'break-word' }}>
                  Parcel ID: {propertyInfo.parcelId}
                  <button
                    style={{
                      marginLeft: 8,
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: `clamp(12px, 1.8vw, 14px)`, color: '#64748B', wordBreak: 'break-word' }}>
                  Represented by: {clientInfo.representedBy || 'N/A'}
                  <button
                    style={{
                      marginLeft: 8,
                      fontSize: `clamp(12px, 1.8vw, 14px)`,
