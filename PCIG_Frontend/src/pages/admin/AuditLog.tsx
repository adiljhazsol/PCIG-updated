...
export default function AuditLog() {
  ...
  const header = data?.header || { title: 'Audit Log', subtitle: 'View system activities' };
  const searchPlaceholder = data?.searchPlaceholder || 'Search audit logs...';
  const filters = data?.filters || [];
  const summary = data?.summary || { label: 'Total Events', value: '0' };
            ...
            <thead>
              ...
              >
                {tableHeaders.map((header: any, idx: number) => (
                    ...
                    style={{
                      padding: '12px 16px',
                      textAlign: header.label === '' ? 'right' : 'left',
                      fontSize: 11,
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: 30,
                            borderRadius: 999,
                            backgroundColor: row.user?.bg || '#F1F5F9',
                            color: row.user?.color || '#64748B',
                            display: 'flex',
                            alignItems: 'center',
                            justifyContent: 'center',
                            fontSize: 12,
                    ...
                    <td style={{ padding: isMobile ? '10px 12px' : '12px 16px', verticalAlign: 'top' }}>
                      <span
                        style={{
                          ...
                          fontSize: 11,
                          fontWeight: 500,
                          backgroundColor: row.actionType?.bg || '#F1F5F9',
                          color: row.actionType?.color || '#64748B'
                        }}
                      >
                        {row.actionType?.label || 'Action'}
                      </span>
                    </td>
