...
import { Building2, Mail, Lock, Eye, EyeOff, Check, Phone, User, MapPin, FileText, CreditCard } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '2vh' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                >
                  <MapPin style={{ width: 'clamp(12px, 1.5vw, 14px)', height: 'clamp(12px, 1.5vw, 14px)' }} />
                </div>
                <input
                  type="text"
                  value={address}
            ...
            <div style={{ marginBottom: '2vh' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                >
                  <FileText style={{ width: 'clamp(12px, 1.5vw, 14px)', height: 'clamp(12px, 1.5vw, 14px)' }} />
                </div>
                <input
                  type="text"
                  value={ssn}
            ...
            <div style={{ marginBottom: '2vh' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                >
                  <CreditCard style={{ width: 'clamp(12px, 1.5vw, 14px)', height: 'clamp(12px, 1.5vw, 14px)' }} />
                </div>
                <input
                  type="text"
                  value={bankAccount}
