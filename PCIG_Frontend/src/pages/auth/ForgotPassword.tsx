...
import { Building2, Mail, Check } from 'lucide-react';
...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Don't reveal if email exists or not for security, or show generic error
      // Ideally backend returns 200 even if email not found, or specific error if validation fails
      // For now we'll assume 200 OK means success
