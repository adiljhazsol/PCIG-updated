...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.response) {
         ...
         setError('Network Error: Server unreachable. Ensure backend is running at http://127.0.0.1:8000');
      } else {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ maxWidth: '420px' }}>
            ...
            >
              Manage properties, workflows, and operations with powerful tools designed for administrators and operations teams.
            </p>

            {/* Feature List */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <FeatureItem text="Complete Workflow Management" />
              <FeatureItem text="Advanced Property Operations" />
              <FeatureItem text="Comprehensive Reporting Tools" />
            </div>
          </div>
      ...
      >
        {/* Investor Button - Desktop Top Right */}
        {!isMobileOrTablet && (
          <button
            onClick={() => navigate('/auth/login')}
            style={{
        ...
        >
          ...
          <div style={{ textAlign: 'center', marginBottom: '20px' }}>
            ...
            <p style={{ fontSize: '13px', color: '#64748b', margin: 0, marginBottom: '20px' }}>
              Enter your credentials to access your admin portal
            </p>
          </div>
