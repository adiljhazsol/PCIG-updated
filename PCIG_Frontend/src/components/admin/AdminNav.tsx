...
export default function AdminNav() {
  ...
  const subNavConfig: { [key: string]: Array<{ label: string; path: string }> } = {
    'Workflow': [
      ...
      { label: 'REO Leased', path: '/admin/properties/reo-leased' },
    ...
    'Investors': [
      ...
      { label: 'Invite Investor', path: '/admin/invite-investor' },
    ],
    'Payments': [
            ...
            >
                ...
                {userDropdownOpen && (
                    <div style={{
                        ...
                        <Link 
                    to="/admin/administration/settings?section=profile" 
                ...
                <Link 
                    to="/admin/administration/notifications-escalation" 
                    onClick={() => setUserDropdownOpen(false)}
                    style={{
                        display: 'flex',
                        alignItems: 'center',
      ...
      {drawerOpen && isMobileOrTablet && (
        ...
        >
          ...
          >
            ...
            <div style={{ padding: 16, borderTop: '1px solid #E2E8F0', marginTop: 'auto' }}>
                <button
